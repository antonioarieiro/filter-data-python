...
# get_job === recebe o job e o id
# se o job["id"] corresponder ao id
# renderizamos o job
...
@bp.route("/job/<index>")
# https://python.hotexamples.com/examples/flask/Blueprint/route/python-blueprint-route-method-examples.html
# https://stackoverflow.com/questions/62735758/flask-routes-using-blueprint-are-not-working-only-route-is-working-on-ubunt
def job(index):
